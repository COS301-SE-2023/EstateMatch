...
export class WebScraperController {
    ...
    async getScrapedPrivatePropertiesRentProperties() {
    ...
    @Get("/RemaxRentScraper")
    async getScrapedRemaxRentProperties() {
        const properties = await this.RemaxRentService.RemaxRentscrape();
